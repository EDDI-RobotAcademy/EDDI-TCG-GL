...
export class MyDeckRemainingOutOfTotalSlashPositionRepositoryImpl implements MyDeckRemainingOutOfTotalSlashPositionRepository {
    ...
    // 검색용 position
    public findSearchSlashPosition(searchResultCount: number): MyDeckRemainingOutOfTotalSlashPosition[] {
        ...
        // 각 positionId에 해당하는 MyDeckRemainingOutOfTotalSlashPosition 가져오기
        const positions: MyDeckRemainingOutOfTotalSlashPosition[] = [];
