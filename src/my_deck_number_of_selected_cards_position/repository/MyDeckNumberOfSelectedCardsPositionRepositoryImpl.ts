...
export class MyDeckNumberOfSelectedCardsPositionRepositoryImpl implements MyDeckNumberOfSelectedCardsPositionRepository {
    ...
    private originalPositionMap: Map<number, { cardId: number, position: MyDeckNumberOfSelectedCardsPosition }> = new Map();
    ...
    public saveClonedOriginalPositionState(deckId: number): void {
        ...
        positionIdList.forEach(positionId => {
            ...
            if (entry) {
                const clonedPosition = new MyDeckNumberOfSelectedCardsPosition(
                    entry.position.getX(),
                    entry.position.getY()
                );
        ...
        console.log(
            'originalNumberOfSelectedCardsPositionMap:',
