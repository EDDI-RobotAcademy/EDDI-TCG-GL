...
import {MyDeckCardNameClonePositionRepository} from "./MyDeckCardNameClonePositionRepository";

export class MyDeckCardNameClonePositionRepositoryImpl implements MyDeckCardNameClonePositionRepository {
    private static instance: MyDeckCardNameClonePositionRepositoryImpl;
    private positionMap: Map< number, MyDeckCardNameClonePosition> = new Map(); // card ID: position
    ...
    public static getInstance(): MyDeckCardNameClonePositionRepositoryImpl {
        if (!MyDeckCardNameClonePositionRepositoryImpl.instance) {
            MyDeckCardNameClonePositionRepositoryImpl.instance = new MyDeckCardNameClonePositionRepositoryImpl();
        }
        return MyDeckCardNameClonePositionRepositoryImpl.instance;
    }

    public addClonePosition(cardId: number): MyDeckCardNameClonePosition {
        ...
        const position = new MyDeckCardNameClonePosition(positionX, positionY);
        this.positionMap.set(cardId, position);

        return position;
    }

    public findPositionByCardId(cardId: number): MyDeckCardNameClonePosition | null {
    ...
    public deleteByCardId(cardId: number): void {
        ...
        for (const id of cardIdList) {
            ...
            const newPosition = new MyDeckCardNameClonePosition(newX, newY);
