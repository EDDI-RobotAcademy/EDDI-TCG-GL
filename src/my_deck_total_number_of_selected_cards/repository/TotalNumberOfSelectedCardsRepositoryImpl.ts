...
export class TotalNumberOfSelectedCardsRepositoryImpl implements TotalNumberOfSelectedCardsRepository {
    ...
    public static getInstance(): TotalNumberOfSelectedCardsRepositoryImpl {
        if (!TotalNumberOfSelectedCardsRepositoryImpl.instance) {
            const textureManager = TextureManager.getInstance();
            TotalNumberOfSelectedCardsRepositoryImpl.instance = new TotalNumberOfSelectedCardsRepositoryImpl(textureManager);
        }
