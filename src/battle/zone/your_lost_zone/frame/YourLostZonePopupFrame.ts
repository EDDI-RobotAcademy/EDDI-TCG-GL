...
export interface YourLostZonePopupFrame {
...
export function createDefaultYourLostZonePopupFrame(): YourLostZonePopupFrame {
    return {
        leftRatio: 0.2,
        rightRatio: 0.8,
        topRatio: 0.2,
...
export interface YourLostZonePopupBounds {
...
export function computeYourLostZonePopupBounds(
    frame: YourLostZonePopupFrame,
    viewportWidth: number,
    viewportHeight: number,
): YourLostZonePopupBounds {
