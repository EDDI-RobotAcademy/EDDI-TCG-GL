...
| **R2-130** | Strategy | Battle Ability | 새 카드 열 장으로 확장 시험 | R2-129 | 예정. **여기부터는 리팩토링이 아니다** |
| **R2-131** | Rendering | Battle 공용 | 체력과 무기 표기를 그림에서 글자로 바꾼다 | R2-46 | 예정. **숫자 없는 바탕 그림 셋이 있어야 한다** |
| **R2-132** | Rule | Battle | 멀리건을 더해 1대1 대전이 되게 한다 | R2-126 | 예정 |
| **R2-133** | Structure | Platform | 사용자에게 내보낼 것을 만드는 명령을 만든다 | R2-82 | 예정 |
| **R2-134** | Rendering | Battle Ability | 광역기 연출을 카드별로 분리 | R2-124 | 예정. **카드가 내놓는 것에 광역기 연출 자리를 먼저 더해야 한다. 네더 블레이드는 신화 등급 연출이 아직 없다** |
