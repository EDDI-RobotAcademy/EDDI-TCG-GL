...
[카드에 붙어 따라다니는 것] 묶음으로 옮겼다. R2-41, R2-45 다.
...
카드 연출 15파일은 카드 종류별로 나눠 R2-32 부터 R2-35 로 옮긴다.
...
4. 화면 조립    R2-38    실제로 도는 두 화면
5. 배경        R2-39    battle_field 안의 배경 여섯 파일
6. 걸쳐 있는 것 R2-41, R2-42   위가 다 끝난 뒤
```

연출(R2-32 부터 R2-35)은 다른 폴더라 위 순서와 부딪히지 않는다. 사이에 아무 때나 넣을 수 있다.
