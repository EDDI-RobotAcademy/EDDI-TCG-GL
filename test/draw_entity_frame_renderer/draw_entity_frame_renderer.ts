...
export class DrawEntityFrameRendererView {
    private static instance: DrawEntityFrameRendererView | null = null;
    ...
    public static getInstance(lobbyContainer?: HTMLElement): DrawEntityFrameRendererView {
        if (!DrawEntityFrameRendererView.instance) {
            if (!lobbyContainer) throw new Error('Root container required for first initialization');
            DrawEntityFrameRendererView.instance = new DrawEntityFrameRendererView(lobbyContainer);
        }
        return DrawEntityFrameRendererView.instance;
    }
...
const fieldView = DrawEntityFrameRendererView.getInstance(rootElement);
